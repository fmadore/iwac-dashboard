...
declare module 'd3-selection' {
  export interface Selection<GElement extends d3.BaseType, Datum, PElement extends d3.BaseType, PDatum> {
    selectAll<DescElement extends d3.BaseType>(selector: string): Selection<DescElement, Datum, GElement, Datum>;
    select<DescElement extends d3.BaseType>(selector: string): Selection<DescElement, Datum, PElement, PDatum>;
    ...
    append<K extends keyof SVGElementTagNameMap>(type: K): Selection<SVGElementTagNameMap[K], Datum, PElement, PDatum>;
    ...
    attr(name: string, value: string | number | boolean | null | ((d: Datum, i: number, group: GElement[]) => string | number | boolean | null)): this;
    style(name: string, value: string | number | null | ((d: Datum, i: number, group: GElement[]) => string | number | null)): this;
    on(typenames: string, listener: ((this: GElement, event: Event, d: Datum) => void) | null): this;
  ...
  export function select<GElement extends d3.BaseType>(selector: string): Selection<GElement, unknown, null, undefined>;
  export function select<GElement extends d3.BaseType>(element: GElement): Selection<GElement, unknown, null, undefined>;
  export function selectAll<GElement extends d3.BaseType>(selector: string): Selection<GElement, unknown, null, undefined>;
}

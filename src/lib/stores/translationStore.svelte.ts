...
export const translations = {
	en: {
		...
		'pagination.showing_range': 'Showing {0}-{1} of {2}',
		'pagination.page_of': 'Page {0} of {1}',
		...
		'network.layout_force': 'Force-directed',
		'network.layout_circular': 'Circular',
		'network.layout_radial': 'Radial',
		'network.fullscreen': 'Fullscreen',
		'network.exit_fullscreen': 'Exit fullscreen',
		'network.edge_focus': 'Edge Focus',
		'network.weight': 'Weight',
		'network.shared_articles': '{0} shared articles',
		'network.shared_neighbors': '{0} shared neighbors',
		'network.more': 'more',
		'network.edge_focus_hint': 'Click anywhere to exit edge focus',
		// Knowledge Graph
		...
		'kg.match_rate': 'Match Rate',
		'kg.type_authority': 'Authority Records',
		'kg.edge_layers': 'Edge Layers',
		'kg.layer_explicit': 'Explicit (curated)',
		'kg.layer_inferred': 'Inferred (co-occurrence)',
		'kg.edge_types': 'Edge Types',
		'kg.edge_part_of': 'Part of',
		'kg.edge_has_part': 'Has part',
		'kg.edge_related_to': 'Related to',
		'kg.edge_succeeded_by': 'Succeeded by',
		...
		'keywords.total_occurrences': 'Total Occurrences',
		'keywords.year_range': 'Year Range',
		'keywords.articles_analyzed': 'Articles Analyzed',
		'keywords.filters': 'Filters',
		'keywords.facet_by': 'Facet By',
		'keywords.global': 'Global',
		'keywords.by_country': 'By Country',
		'keywords.by_newspaper': 'By Newspaper',
		'keywords.select_country': 'Select Country',
		'keywords.select_newspaper': 'Select Newspaper',
		'keywords.all_countries': 'All Countries',
		'keywords.all_newspapers': 'All Newspapers',
		'keywords.view_mode': 'View Mode',
		'keywords.top_frequent': 'Top Frequent',
		'keywords.compare': 'Compare',
		'keywords.number_to_show': 'Number to Show',
		'keywords.keywords': 'keywords',
		'keywords.select_keywords': 'Select Keywords',
		'keywords.select_up_to': 'Select up to {0} keywords',
		'keywords.search_keywords': 'Search keywords...',
		'keywords.select_keywords_prompt': 'Select keywords to compare',
		'keywords.top_n_over_time': 'Top {0} Keywords Over Time',
		'keywords.comparison_chart': 'Keyword Comparison',
		'keywords.filtered_by_country': 'Filtered by country: {0}',
		'keywords.filtered_by_newspaper': 'Filtered by newspaper: {0}',
		'keywords.all_data': 'All data (global)',
		'keywords.all_keywords_table': 'All Keywords',
		'keywords.showing_keywords': 'Showing {0} of {1} keywords',
		'keywords.rank': 'Rank',
		'keywords.keyword': 'Keyword',
		'keywords.occurrences': 'Occurrences',
		'keywords.articles': 'Articles',
		'keywords.actions': 'Actions',
		'keywords.add': 'Add',
		'keywords.remove': 'Remove',
		'keywords.dataset_info': 'Dataset Information',
		'keywords.generated_at': 'Generated',
		'keywords.total_articles': 'Total Articles',
		'keywords.countries_count': 'Countries',
		'keywords.newspapers_count': 'Newspapers',
		'keywords.chart_aria': 'Line chart showing keyword prevalence over time',
		'keywords.no_data_for_country': 'No data available for selected keywords in {0}',
		'keywords.no_data_for_newspaper': 'No data available for selected keywords in {0}',
		'keywords.try_different_filters': 'Try selecting different filters or keywords',
		'keywords.clear_filters': 'Clear Filters',
		'keywords.showing_range': 'Showing {0}-{1} of {2} keywords',
		'keywords.page_of': 'Page {0} of {1}',
		...
		'topic_network.filter_by_topic': 'Filter by Topic',
		'topic_network.all_topics': 'All Topics',
		'topic_network.link_threshold': 'Link Threshold',
		'topic_network.topic_probability': 'Topic Probability',
		'topic_network.view_article': 'View Article',
		'topic_network.article_count': '{0} articles',
		'topic_network.no_selection': 'Click on an article to see details',
		'topic_network.avg_probability': 'Avg. Probability',
		'topic_network.connections': 'Connections',
		'topic_network.search_topics': 'Search topics...',
		'topic_network.topic_details': 'Topic Details',
		'topic_network.article_details': 'Article Details',
		'topic_network.country': 'Country',
		'topic_network.newspaper': 'Newspaper',
		...
		'semantic_map.embedding_dim': 'Embedding',
		'semantic_map.color_by': 'Color by',
		'semantic_map.color_country': 'Country',
		'semantic_map.color_topic': 'Topic',
		'semantic_map.color_newspaper': 'Newspaper',
		'semantic_map.color_sentiment': 'Sentiment',
		'semantic_map.color_polarity': 'Polarity',
		'semantic_map.color_decade': 'Decade',
		'semantic_map.total_points': 'Total points',
		'semantic_map.topic': 'Topic',
		'semantic_map.sentiment': 'Sentiment',
		'semantic_map.polarity': 'Polarity',
		'semantic_map.sentiment_positive': 'Positive',
		'semantic_map.sentiment_negative': 'Negative',
		'semantic_map.sentiment_neutral': 'Neutral',
		'semantic_map.polarity_very_positive': 'Very positive',
		'semantic_map.polarity_positive': 'Positive',
		'semantic_map.polarity_neutral': 'Neutral',
		'semantic_map.polarity_negative': 'Negative',
		'semantic_map.polarity_very_negative': 'Very negative',
		...
		'semantic_map.all_countries': 'All Countries',
		'semantic_map.loading_country': 'Loading country data...',
		// Publishers
		'nav.publishers': 'Publishers',
		'publishers.title': 'Publishers',
		'publishers.description': 'Top publishers by publication count in the bibliographic references',
		'publishers.total_publishers': 'Total Publishers',
		'publishers.total_publications': 'Total Publications',
		'publishers.avg_per_publisher': 'Avg per Publisher',
		'publishers.publisher': 'Publisher',
		'publishers.publications': 'Publications',
		'publishers.year_range': 'Year Range',
		'publishers.top_type': 'Most Common Type',
		'publishers.table_title': 'Publishers by Publication Count',
		'publishers.table_description': 'Search and explore publishers',
		'publishers.run_script_hint': 'This visualization requires data generation. Please run:',
		// Co-author Network
		...
		'coauthor.visible_connections': 'Visible Connections',
		'coauthor.max_authors': 'Max Authors',
		'coauthor.min_coauthorships': 'Min Co-authorships',
		'coauthor.size_by_publications': 'By Publications',
		'coauthor.size_by_coauthors': 'By Co-authors',
		'coauthor.size_by_collaborations': 'By Total Collaborations',
		'coauthor.author': 'Author',
		'coauthor.authors': 'Authors',
		...
		'subject_cooccurrence.visible_connections': 'Visible Connections',
		'subject_cooccurrence.max_topics': 'Max Topics',
		'subject_cooccurrence.min_cooccurrences': 'Min Co-occurrences',
		'subject_cooccurrence.size_by_references': 'By References',
		'subject_cooccurrence.size_by_connected': 'By Connected Topics',
		'subject_cooccurrence.size_by_cooccurrences': 'By Total Co-occurrences',
		'subject_cooccurrence.subject': 'Subject',
		'subject_cooccurrence.subjects': 'Subjects',
	...
	fr: {
		...
		'pagination.showing_range': 'Affichage {0}-{1} sur {2}',
		'pagination.page_of': 'Page {0} sur {1}',
		...
		'network.layout': 'Disposition',
		'network.layout_force': 'Force dirigée',
		'network.layout_circular': 'Circulaire',
		...
		'kg.edge_types': 'Types de liens',
		'kg.edge_part_of': 'Partie de',
		'kg.edge_has_part': 'Comprend',
		'kg.edge_related_to': 'Lié à',
		'kg.edge_succeeded_by': 'Remplacé par',
		...
		'keywords.total_occurrences': 'Occurrences totales',
		'keywords.year_range': 'Période',
		'keywords.articles_analyzed': 'Articles analysés',
		'keywords.filters': 'Filtres',
		'keywords.facet_by': 'Facetter par',
		'keywords.global': 'Global',
		'keywords.by_country': 'Par pays',
		'keywords.by_newspaper': 'Par journal',
		'keywords.select_country': 'Sélectionner un pays',
		'keywords.select_newspaper': 'Sélectionner un journal',
		'keywords.all_countries': 'Tous les pays',
		'keywords.all_newspapers': 'Tous les journaux',
		'keywords.view_mode': 'Mode de vue',
		'keywords.top_frequent': 'Plus fréquents',
		'keywords.compare': 'Comparer',
		...
		'keywords.comparison_chart': 'Comparaison de mots-clés',
		'keywords.filtered_by_country': 'Filtré par pays : {0}',
		'keywords.filtered_by_newspaper': 'Filtré par journal : {0}',
		'keywords.all_data': 'Toutes les données (global)',
		'keywords.all_keywords_table': 'Tous les mots-clés',
		'keywords.showing_keywords': 'Affichage de {0} sur {1} mots-clés',
		'keywords.rank': 'Rang',
		...
		'keywords.remove': 'Retirer',
		'keywords.dataset_info': 'Informations sur le jeu de données',
		'keywords.generated_at': 'Généré',
		...
		'keywords.page_of': 'Page {0} sur {1}',
		'keywords.previous': 'Précédent',
		'keywords.next': 'Suivant',
		// Topic Network
		...
		'topic_network.filter_by_topic': 'Filtrer par topic',
		...
		'semantic_map.topics': 'Topics',
		'semantic_map.embedding_dim': 'Embedding',
		'semantic_map.color_by': 'Colorer par',
		'semantic_map.color_country': 'Pays',
		'semantic_map.color_topic': 'Topic',
		'semantic_map.color_newspaper': 'Journal',
		'semantic_map.color_sentiment': 'Sentiment',
		'semantic_map.color_polarity': 'Polarité',
		'semantic_map.color_decade': 'Décennie',
		'semantic_map.total_points': 'Points totaux',
		'semantic_map.topic': 'Topic',
		'semantic_map.sentiment': 'Sentiment',
		'semantic_map.polarity': 'Polarité',
		'semantic_map.sentiment_positive': 'Positif',
		'semantic_map.sentiment_negative': 'Négatif',
		'semantic_map.sentiment_neutral': 'Neutre',
		'semantic_map.polarity_very_positive': 'Très positif',
		'semantic_map.polarity_positive': 'Positif',
		'semantic_map.polarity_neutral': 'Neutre',
		'semantic_map.polarity_negative': 'Négatif',
		'semantic_map.polarity_very_negative': 'Très négatif',
		...
		'semantic_map.loading_country': 'Chargement des données du pays...',
		// Publishers
		...
		'publishers.publisher': 'Éditeur',
		'publishers.publications': 'Publications',
		'publishers.year_range': 'Période',
		...
		'coauthor.visible_connections': 'Connexions visibles',
		'coauthor.max_authors': 'Auteurs max',
		'coauthor.min_coauthorships': 'Co-signatures min',
		'coauthor.size_by_publications': 'Par publications',
		'coauthor.size_by_coauthors': 'Par co-auteurs',
		'coauthor.size_by_collaborations': 'Par collaborations totales',
		'coauthor.author': 'Auteur',
		'coauthor.authors': 'Auteurs',
		'coauthor.publications': 'Publications',
		...
		'subject_cooccurrence.visible_connections': 'Connexions visibles',
		'subject_cooccurrence.max_topics': 'Sujets max',
		'subject_cooccurrence.min_cooccurrences': 'Co-occurrences min',
		'subject_cooccurrence.size_by_references': 'Par références',
		'subject_cooccurrence.size_by_connected': 'Par sujets connectés',
		'subject_cooccurrence.size_by_cooccurrences': 'Par co-occurrences totales',
		'subject_cooccurrence.subject': 'Sujet',
		'subject_cooccurrence.subjects': 'Sujets',
